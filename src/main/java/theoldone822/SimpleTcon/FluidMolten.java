...
public class FluidMolten extends FluidColored {
  ...
  public static ResourceLocation ICON_MetalStill = new ResourceLocation("simpletcon", "blocks/fluids/molten_metal");
  public static ResourceLocation ICON_MetalFlowing = new ResourceLocation("simpletcon", "blocks/fluids/molten_metal_flow");
